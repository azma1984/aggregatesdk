...
class com::tibbo::aggregate::common::context::DefaultContextManager_contextRemoved_1
...
public:
    ...
    // Generated
    DefaultContextManager_contextRemoved_1(DefaultContextManager *DefaultContextManager_this);
