...
private:
    EventData* ed;
    ::com::tibbo::aggregate::common::data::Event* ev;
protected:
    void ctor(EventData* ed, ::com::tibbo::aggregate::common::data::Event* ev);

public:
    void dispatch();

    // Generated
    DefaultContextManager_QueuedEvent(DefaultContextManager *DefaultContextManager_this, EventData* ed, ::com::tibbo::aggregate::common::data::Event* ev);
protected:
