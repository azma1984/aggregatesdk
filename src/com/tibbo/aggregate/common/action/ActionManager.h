...
public:
	...
	std::list<ActionDefinitionPtr> resolveDefinitions(std::list<ActionLocator> *actionLocators);
	ActionIdentifierPtr initActions(std::list<BatchEntry>  entries, ActionContextPtr batchActionContext);
