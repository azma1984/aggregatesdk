    ...
    : public ServerContext
{
    ...
    std::list  getAssets();
    SettingSynchronizationOptions* getSynchronizationOptions(std::string* variable);
    ...
    void setDefaultSynchronizationOptions(std::string* variable, SettingSynchronizationOptions* options);
    void setDefaultSynchronizationOptions(std::string* variable, bool local, SettingSynchronizationOptions* options);
    void setCustomSynchronizationHandler(std::string* variable, SynchronizationHandler* handler, bool forceCustomSyncMode);
    ...
    void asyncVariableUpdate(std::string* variable, DataTable* value) /* throws(DisconnectionException, ContextException, DeviceException) */;
    void processHistoricalValue(std::string* variable, Date* timestamp, DataTable* value) /* throws(ContextException) */;
    std::mutex ** getSynchronizationLock();
    SynchronizationResult* executeSynchronization(SynchronizationParameters* parameters);
    void setOnline(bool online);
    VariableDefinition* discoverDeviceVariable(std::string* name, int timeout, void* helper) /* throws(ContextException) */;
    FunctionDefinition* discoverDeviceFunction(std::string* name, int timeout, void* helper) /* throws(ContextException) */;
    EventDefinition* discoverDeviceEvent(std::string* name, int timeout, void* helper) /* throws(ContextException) */;
};
