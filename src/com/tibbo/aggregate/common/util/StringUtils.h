...
public:
    ...
    static const std::string print(std::list col);
    static const std::string print(std::list col, const std::string & separator);
    static const std::string print(std::list col, const std::string & separator, bool skipNullElements);
    static const std::string print(std::list col, const std::string & separator, const std::string & escaper, bool skipNullElements);
    ...
    static std::list  split(const std::string & str, int ch);
    static std::list  split(const std::string & str, int ch, int limit);
