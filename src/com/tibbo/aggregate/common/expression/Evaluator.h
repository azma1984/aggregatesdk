...
//    void ctor(::com::tibbo::aggregate::common::context::ContextManager* cm, ::com::tibbo::aggregate::common::context::Context* defaultContext, DataTable* defaultTable, ::com::tibbo::aggregate::common::context::CallerController* caller);
...
//    Evaluator(::com::tibbo::aggregate::common::context::ContextManager* cm, ::com::tibbo::aggregate::common::context::Context* defaultContext, DataTable* defaultTable, ::com::tibbo::aggregate::common::context::CallerController* caller);
