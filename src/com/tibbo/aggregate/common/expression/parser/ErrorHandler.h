...
JAVACC_SIMPLE_STRING addUnicodeEscapes(JAVACC_STRING_TYPE str);
  ...
  class ErrorHandler {
    friend class ExpressionParserTokenManager;
    ...
    public:
      ...
      virtual void handleUnexpectedToken(int expectedKind, JAVACC_STRING_TYPE expectedToken, Token *actual, ExpressionParser *parser) {
        error_count++;
      ...
      virtual void handleParseError(Token *last, Token *unexpected, JAVACC_SIMPLE_STRING production, ExpressionParser *parser) {
        error_count++;
      ...
      virtual void handleOtherError(JAVACC_STRING_TYPE message, ExpressionParser *parser) {
  ...
  class TokenManagerErrorHandler {
    ...
    public:
       ...
       //
       virtual void lexicalError(bool EOFSeen, int lexState, int errorLine, int errorColumn, JAVACC_STRING_TYPE errorAfter, JAVACC_CHAR_TYPE curChar, ExpressionParserTokenManager* token_manager) {
       ...
       virtual void lexicalError(JAVACC_STRING_TYPE errorMessage, ExpressionParserTokenManager* token_manager) {
...
#endif
/* JavaCC - OriginalChecksum=fdcba6b1a017bb5cd50171a841409d0a (do not edit this line) */
