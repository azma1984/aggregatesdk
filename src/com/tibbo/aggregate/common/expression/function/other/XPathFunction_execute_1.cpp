...
function::other::XPathFunction_execute_1::XPathFunction_execute_1(XPathFunction *XPathFunction_this)
...
org::xml::sax::InputSource* function::other::XPathFunction_execute_1::resolveEntity(const std::string & publicId, const std::string & systemId)
{
...
java::lang::Class* function::other::XPathFunction_execute_1::class_()
{
    static ::java::lang::Class* c = ::class_(u"", 0);
    return c;
}

java::lang::Class* function::other::XPathFunction_execute_1::getClass0()
{
    return class_();
}
