...
java::lang::Class* com::tibbo::aggregate::common::binding::ReferenceWriter::class_()
{
    static AgClassPtr c = ::class_(u"com.tibbo.aggregate.common.binding.ReferenceWriter", 50);
    return c;
}
