...
class com::tibbo::aggregate::common::binding::DefaultBindingProcessor_EvaluationTimerTask_run_1
...
public:
    ...
    // Generated
    DefaultBindingProcessor_EvaluationTimerTask_run_1(DefaultBindingProcessor_EvaluationTimerTask *DefaultBindingProcessor_EvaluationTimerTask_this);
    
    DefaultBindingProcessor_EvaluationTimerTask *DefaultBindingProcessor_EvaluationTimerTask_this;
