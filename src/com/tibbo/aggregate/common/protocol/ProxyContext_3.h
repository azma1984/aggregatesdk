...
class com::tibbo::aggregate::common::protocol::ProxyContext_3
...
public:
    ...
    // Generated
    ProxyContext_3(ProxyContext *ProxyContext_this);
    ProxyContext_3(ProxyContext *ProxyContext_this, ::com::tibbo::aggregate::common::context::CallerController* callerController);
    ProxyContext_3(ProxyContext *ProxyContext_this, ::com::tibbo::aggregate::common::context::CallerController* callerController, ::java::lang::Integer* listenerCode);
    ProxyContext_3(ProxyContext *ProxyContext_this, ::com::tibbo::aggregate::common::context::CallerController* callerController, ::java::lang::Integer* listenerCode, ::com::tibbo::aggregate::common::expression::Expression* filter);
    ProxyContext_3(ProxyContext *ProxyContext_this, ::java::lang::Integer* listenerCode);
