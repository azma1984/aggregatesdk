...
class com::tibbo::aggregate::common::protocol::ProxyContext_setupMyself_5
...
public:
    ...
    // Generated
    ProxyContext_setupMyself_5(ProxyContext *ProxyContext_this);
    ProxyContext_setupMyself_5(ProxyContext *ProxyContext_this, ::com::tibbo::aggregate::common::context::CallerController* callerController);
    ProxyContext_setupMyself_5(ProxyContext *ProxyContext_this, ::com::tibbo::aggregate::common::context::CallerController* callerController, ::java::lang::Integer* listenerCode);
    ProxyContext_setupMyself_5(ProxyContext *ProxyContext_this, ::com::tibbo::aggregate::common::context::CallerController* callerController, ::java::lang::Integer* listenerCode, ::com::tibbo::aggregate::common::expression::Expression* filter);
    ProxyContext_setupMyself_5(ProxyContext *ProxyContext_this, ::java::lang::Integer* listenerCode);
