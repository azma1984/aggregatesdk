...
class com::tibbo::aggregate::common::protocol::ProxyContext_2
...
public:
    ...
    // Generated
    ProxyContext_2(ProxyContext *ProxyContext_this);
    ProxyContext_2(ProxyContext *ProxyContext_this, ::com::tibbo::aggregate::common::context::CallerController* callerController);
    ProxyContext_2(ProxyContext *ProxyContext_this, ::com::tibbo::aggregate::common::context::CallerController* callerController, ::java::lang::Integer* listenerCode);
    ProxyContext_2(ProxyContext *ProxyContext_this, ::com::tibbo::aggregate::common::context::CallerController* callerController, ::java::lang::Integer* listenerCode, ::com::tibbo::aggregate::common::expression::Expression* filter);
    ProxyContext_2(ProxyContext *ProxyContext_this, ::java::lang::Integer* listenerCode);
