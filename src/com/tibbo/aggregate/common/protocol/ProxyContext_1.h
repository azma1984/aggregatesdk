...
class com::tibbo::aggregate::common::protocol::ProxyContext_1
...
public:
    ...
    // Generated
    ProxyContext_1(ProxyContext *ProxyContext_this);
    ProxyContext_1(ProxyContext *ProxyContext_this, ::com::tibbo::aggregate::common::context::CallerController* callerController);
    ProxyContext_1(ProxyContext *ProxyContext_this, ::com::tibbo::aggregate::common::context::CallerController* callerController, ::java::lang::Integer* listenerCode);
    ProxyContext_1(ProxyContext *ProxyContext_this, ::com::tibbo::aggregate::common::context::CallerController* callerController, ::java::lang::Integer* listenerCode, ::com::tibbo::aggregate::common::expression::Expression* filter);
    ProxyContext_1(ProxyContext *ProxyContext_this, ::java::lang::Integer* listenerCode);
