...
class com::tibbo::aggregate::common::datatable::converter::FCDouble
...
public:
    ...
    void* convertToTable(::java::lang::Double* value, ::com::tibbo::aggregate::common::datatable::TableFormat* format);
