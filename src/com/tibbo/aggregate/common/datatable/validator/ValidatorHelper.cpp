...
//#include <limits>
   ...
   static boost::shared_ptr<FieldValidator> ValidatorHelper::NAME_SYNTAX_VALIDATOR_;
    static boost::shared_ptr<FieldValidator> ValidatorHelper::NAME_LENGTH_VALIDATOR_;
//
